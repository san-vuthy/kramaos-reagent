...
var o30631 = temp__5455__auto__;
var temp__5455__auto____$1 = (o30631["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o30632 = temp__5455__auto____$1;
return (o30632["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__29947__auto__ = f;
return (o__29947__auto__["toString"]).call(o__29947__auto__);
} else {
return "";
}
}catch (e30633){var _ = e30633;
return "";
}});
...
try{var o__29947__auto___30635 = t;
(o__29947__auto___30635["cljs$lang$ctorPrWriter"]).call(o__29947__auto___30635,t,writer);
}catch (e30634){var __30636 = e30634;
}
...
var char_code = (function (){var o__29947__auto__ = (new String(char$));
return (o__29947__auto__["charCodeAt"]).call(o__29947__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__29947__auto__ = String;
return (o__29947__auto__["fromCharCode"]).call(o__29947__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__30637 = num_code;
switch (G__30637) {
case (1):
return (185);
...
var o__29947__auto__ = String;
return (o__29947__auto__["fromCharCode"]).call(o__29947__auto__,superscript_code);
});
/**
...
}catch (e30639){var _e__29954__auto__ = e30639;
return false;
}})())){
...
var vec__30640 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__30640,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o30643 = temp__5455__auto__;
var temp__5455__auto____$1 = (o30643["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o30644 = temp__5455__auto____$1;
return (o30644["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4641__auto___30651 = arguments.length;
var i__4642__auto___30652 = (0);
while(true){
if((i__4642__auto___30652 < len__4641__auto___30651)){
args__4647__auto__.push((arguments[i__4642__auto___30652]));

var G__30653 = (i__4642__auto___30652 + (1));
i__4642__auto___30652 = G__30653;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__30647){
var vec__30648 = p__30647;
var ns_detector = cljs.core.nth.call(null,vec__30648,(0),null);
...
var G__30654 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__30655 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__30654;
remaining_tokens = G__30655;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq30645){
var G__30646 = cljs.core.first.call(null,seq30645);
var seq30645__$1 = cljs.core.next.call(null,seq30645);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30646,seq30645__$1);
});
...
var vec__30659 = cljs.core.split_with.call(null,(function (p1__30658_SHARP_){
return cljs.core.not_EQ_.call(null,p1__30658_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__30659,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__30659,(1),null);
...
var vec__30662 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__30662,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__30662,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__30665 = cljs.core.rest.call(null,remaining_tokens);
var G__30666 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__30665;
name_tokens = G__30666;
continue;
} else {
...
var vec__30669 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__30669,(0),null);
var arity = cljs.core.nth.call(null,vec__30669,(1),null);
var vec__30672 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__30672,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__30672,(1),null);
var vec__30675 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__30675,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__30675,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__30675,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__30675,(3),null);
...
var vec__30681 = result;
var munged_ns = cljs.core.nth.call(null,vec__30681,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__30681,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__30681,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__30681,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__30681,(4),null);
var arity = cljs.core.nth.call(null,vec__30681,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__30685 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__30685,(0),null);
var args = cljs.core.nth.call(null,vec__30685,(1),null);
var vec__30688 = devtools.munging.break_and_demunge_name.call(null,munged_name);
...
var G__30691 = (arity + (1));
var G__30692 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__30693){
var vec__30694 = p__30693;
var arity = cljs.core.nth.call(null,vec__30694,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__30694,(1),null);
...
return cljs.core.get.call(null,arities,p1__30697_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__30698_SHARP_);
...
var args__4647__auto__ = [];
var len__4641__auto___30705 = arguments.length;
var i__4642__auto___30706 = (0);
while(true){
if((i__4642__auto___30706 < len__4641__auto___30705)){
args__4647__auto__.push((arguments[i__4642__auto___30706]));

var G__30707 = (i__4642__auto___30706 + (1));
i__4642__auto___30706 = G__30707;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__30701){
var vec__30702 = p__30701;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__30702,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq30699){
var G__30700 = cljs.core.first.call(null,seq30699);
var seq30699__$1 = cljs.core.next.call(null,seq30699);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__30700,seq30699__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__30710__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__30710__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__30710__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__30710__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__30711 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__30711,(0),null);
var fn_name = cljs.core.nth.call(null,vec__30711,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__30711,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__30711,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__30711,(4),null);
var arity = cljs.core.nth.call(null,vec__30711,(5),null);
...
var o__29947__auto__ = f;
return (o__29947__auto__["getBasis"]).call(o__29947__auto__);
});
/**
...
}catch (e30715){var _e__29954__auto__ = e30715;
...
var G__30716 = (obj[cljs.core.first.call(null,path)]);
var G__30717 = cljs.core.rest.call(null,path);
obj = G__30716;
path = G__30717;
continue;
} else {
...
return (function (accum,p__30718){
var vec__30719 = p__30718;
var bit = cljs.core.nth.call(null,vec__30719,(0),null);
var protocol = cljs.core.nth.call(null,vec__30719,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__30722){
var vec__30723 = p__30722;
var ns = cljs.core.nth.call(null,vec__30723,(0),null);
var name = cljs.core.nth.call(null,vec__30723,(1),null);
var selector = cljs.core.nth.call(null,vec__30723,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__30728,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__30728,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__30728,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__30726_SHARP_){
return (obj[cljs.core.first.call(null,p1__30726_SHARP_)]);
});})(name,sorted_matches,vec__30728,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1547002152324
