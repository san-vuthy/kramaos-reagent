...
var o29118 = temp__5455__auto__;
var temp__5455__auto____$1 = (o29118["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o29119 = temp__5455__auto____$1;
return (o29119["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__28776__auto__ = f;
return (o__28776__auto__["toString"]).call(o__28776__auto__);
} else {
return "";
}
}catch (e29120){var _ = e29120;
return "";
}});
...
try{var o__28776__auto___29122 = t;
(o__28776__auto___29122["cljs$lang$ctorPrWriter"]).call(o__28776__auto___29122,t,writer);
}catch (e29121){var __29123 = e29121;
}
...
var char_code = (function (){var o__28776__auto__ = (new String(char$));
return (o__28776__auto__["charCodeAt"]).call(o__28776__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__28776__auto__ = String;
return (o__28776__auto__["fromCharCode"]).call(o__28776__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__29124 = num_code;
switch (G__29124) {
case (1):
return (185);
...
var o__28776__auto__ = String;
return (o__28776__auto__["fromCharCode"]).call(o__28776__auto__,superscript_code);
});
/**
...
}catch (e29126){var _e__28783__auto__ = e29126;
return false;
}})())){
...
var vec__29127 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__29127,(0),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var o29130 = temp__5455__auto__;
var temp__5455__auto____$1 = (o29130["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o29131 = temp__5455__auto____$1;
return (o29131["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__29134){
var vec__29135 = p__29134;
var ns_detector = cljs.core.nth.call(null,vec__29135,(0),null);
...
var G__29141 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__29142 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__29141;
remaining_tokens = G__29142;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq29132){
var G__29133 = cljs.core.first.call(null,seq29132);
var seq29132__$1 = cljs.core.next.call(null,seq29132);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29133,seq29132__$1);
});
...
var vec__29146 = cljs.core.split_with.call(null,(function (p1__29145_SHARP_){
return cljs.core.not_EQ_.call(null,p1__29145_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__29146,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__29146,(1),null);
...
var vec__29149 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__29149,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__29149,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__29152 = cljs.core.rest.call(null,remaining_tokens);
var G__29153 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__29152;
name_tokens = G__29153;
continue;
} else {
...
var vec__29156 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__29156,(0),null);
var arity = cljs.core.nth.call(null,vec__29156,(1),null);
var vec__29159 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__29159,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__29159,(1),null);
var vec__29162 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__29162,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__29162,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__29162,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__29162,(3),null);
...
var vec__29168 = result;
var munged_ns = cljs.core.nth.call(null,vec__29168,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__29168,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__29168,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__29168,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__29168,(4),null);
var arity = cljs.core.nth.call(null,vec__29168,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__29172 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__29172,(0),null);
var args = cljs.core.nth.call(null,vec__29172,(1),null);
var vec__29175 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__29175,(0),null);
var name = cljs.core.nth.call(null,vec__29175,(1),null);
...
var G__29178 = (arity + (1));
var G__29179 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__29180){
var vec__29181 = p__29180;
var arity = cljs.core.nth.call(null,vec__29181,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__29181,(1),null);
...
return cljs.core.get.call(null,arities,p1__29184_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__29185_SHARP_);
...
var args__4647__auto__ = [];
var len__4641__auto___29192 = arguments.length;
var i__4642__auto___29193 = (0);
while(true){
if((i__4642__auto___29193 < len__4641__auto___29192)){
args__4647__auto__.push((arguments[i__4642__auto___29193]));

var G__29194 = (i__4642__auto___29193 + (1));
i__4642__auto___29193 = G__29194;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__29188){
var vec__29189 = p__29188;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__29189,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq29186){
var G__29187 = cljs.core.first.call(null,seq29186);
var seq29186__$1 = cljs.core.next.call(null,seq29186);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29187,seq29186__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__29197__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__29197__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__29197__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__29197__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__29198 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__29198,(0),null);
var fn_name = cljs.core.nth.call(null,vec__29198,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__29198,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__29198,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__29198,(4),null);
var arity = cljs.core.nth.call(null,vec__29198,(5),null);
...
var o__28776__auto__ = f;
return (o__28776__auto__["getBasis"]).call(o__28776__auto__);
});
/**
...
}catch (e29202){var _e__28783__auto__ = e29202;
...
var G__29203 = (obj[cljs.core.first.call(null,path)]);
var G__29204 = cljs.core.rest.call(null,path);
obj = G__29203;
path = G__29204;
continue;
} else {
...
return (function (accum,p__29205){
var vec__29206 = p__29205;
var bit = cljs.core.nth.call(null,vec__29206,(0),null);
var protocol = cljs.core.nth.call(null,vec__29206,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__29209){
var vec__29210 = p__29209;
var ns = cljs.core.nth.call(null,vec__29210,(0),null);
var name = cljs.core.nth.call(null,vec__29210,(1),null);
var selector = cljs.core.nth.call(null,vec__29210,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__29215,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__29215,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__29215,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__29213_SHARP_){
return (obj[cljs.core.first.call(null,p1__29213_SHARP_)]);
});})(name,sorted_matches,vec__29215,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1545662203097
