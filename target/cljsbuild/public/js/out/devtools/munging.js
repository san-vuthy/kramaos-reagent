...
var o29117 = temp__5455__auto__;
var temp__5455__auto____$1 = (o29117["core"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o29118 = temp__5455__auto____$1;
return (o29118["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__28775__auto__ = f;
return (o__28775__auto__["toString"]).call(o__28775__auto__);
} else {
return "";
}
}catch (e29119){var _ = e29119;
return "";
}});
...
try{var o__28775__auto___29121 = t;
(o__28775__auto___29121["cljs$lang$ctorPrWriter"]).call(o__28775__auto___29121,t,writer);
}catch (e29120){var __29122 = e29120;
}
...
var char_code = (function (){var o__28775__auto__ = (new String(char$));
return (o__28775__auto__["charCodeAt"]).call(o__28775__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__28775__auto__ = String;
return (o__28775__auto__["fromCharCode"]).call(o__28775__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__29123 = num_code;
switch (G__29123) {
case (1):
return (185);
...
var o__28775__auto__ = String;
return (o__28775__auto__["fromCharCode"]).call(o__28775__auto__,superscript_code);
});
/**
...
}catch (e29125){var _e__28782__auto__ = e29125;
return false;
}})())){
...
var vec__29126 = devtools.munging.parse_fn_source.call(null,fn_source);
var name__$1 = cljs.core.nth.call(null,vec__29126,(0),null);
...
var or__4047__auto__ = (function (){var temp__5455__auto__ = cljs.core.re_matches.call(null,/(.*)\$/,s);
if(cljs.core.truth_(temp__5455__auto__)){
...
var temp__5455__auto____$1 = (o29129["dependencies_"]);
if(cljs.core.truth_(temp__5455__auto____$1)){
var o29130 = temp__5455__auto____$1;
return (o29130["nameToPath"]);
} else {
return null;
}
} else {
...
var len__4641__auto___29137 = arguments.length;
var i__4642__auto___29138 = (0);
while(true){
if((i__4642__auto___29138 < len__4641__auto___29137)){
args__4647__auto__.push((arguments[i__4642__auto___29138]));

var G__29139 = (i__4642__auto___29138 + (1));
i__4642__auto___29138 = G__29139;
continue;
} else {
}
break;
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__29133){
var vec__29134 = p__29133;
var ns_detector = cljs.core.nth.call(null,vec__29134,(0),null);
...
var G__29140 = cljs.core.concat.call(null,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last.call(null,remaining_tokens)], null),name_tokens);
var G__29141 = cljs.core.butlast.call(null,remaining_tokens);
name_tokens = G__29140;
remaining_tokens = G__29141;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq29131){
var G__29132 = cljs.core.first.call(null,seq29131);
var seq29131__$1 = cljs.core.next.call(null,seq29131);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29132,seq29131__$1);
});
...
var vec__29145 = cljs.core.split_with.call(null,(function (p1__29144_SHARP_){
return cljs.core.not_EQ_.call(null,p1__29144_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.call(null,vec__29145,(0),null);
var arity_tokens = cljs.core.nth.call(null,vec__29145,(1),null);
...
var vec__29148 = devtools.munging.detect_namespace_prefix.call(null,remaining_tokens,detector);
var protocol_ns = cljs.core.nth.call(null,vec__29148,(0),null);
var name_and_method_tokens = cljs.core.nth.call(null,vec__29148,(1),null);
if(cljs.core.empty_QMARK_.call(null,protocol_ns)){
var G__29151 = cljs.core.rest.call(null,remaining_tokens);
var G__29152 = cljs.core.conj.call(null,name_tokens,cljs.core.first.call(null,remaining_tokens));
remaining_tokens = G__29151;
name_tokens = G__29152;
continue;
} else {
...
var vec__29155 = devtools.munging.strip_arity.call(null,tokens);
var tokens__$1 = cljs.core.nth.call(null,vec__29155,(0),null);
var arity = cljs.core.nth.call(null,vec__29155,(1),null);
var vec__29158 = devtools.munging.detect_namespace_prefix.call(null,tokens__$1,effective_detector);
var fn_ns = cljs.core.nth.call(null,vec__29158,(0),null);
var tokens__$2 = cljs.core.nth.call(null,vec__29158,(1),null);
var vec__29161 = devtools.munging.parse_protocol.call(null,tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.call(null,vec__29161,(0),null);
var protocol_ns = cljs.core.nth.call(null,vec__29161,(1),null);
var protocol_name = cljs.core.nth.call(null,vec__29161,(2),null);
var protocol_method_tokens = cljs.core.nth.call(null,vec__29161,(3),null);
...
var vec__29167 = result;
var munged_ns = cljs.core.nth.call(null,vec__29167,(0),null);
var munged_name__$1 = cljs.core.nth.call(null,vec__29167,(1),null);
var munged_protocol_ns = cljs.core.nth.call(null,vec__29167,(2),null);
var munged_protocol_name = cljs.core.nth.call(null,vec__29167,(3),null);
var munged_protocol_method = cljs.core.nth.call(null,vec__29167,(4),null);
var arity = cljs.core.nth.call(null,vec__29167,(5),null);
...
if(cljs.core.truth_(temp__5455__auto__)){
var vec__29171 = temp__5455__auto__;
var munged_name = cljs.core.nth.call(null,vec__29171,(0),null);
var args = cljs.core.nth.call(null,vec__29171,(1),null);
var vec__29174 = devtools.munging.break_and_demunge_name.call(null,munged_name);
var ns = cljs.core.nth.call(null,vec__29174,(0),null);
var name = cljs.core.nth.call(null,vec__29174,(1),null);
...
var G__29177 = (arity + (1));
var G__29178 = (function (){var temp__5455__auto__ = devtools.munging.get_fn_fixed_arity.call(null,f,arity);
if(cljs.core.truth_(temp__5455__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__29179){
var vec__29180 = p__29179;
var arity = cljs.core.nth.call(null,vec__29180,(0),null);
var arity_fn = cljs.core.nth.call(null,vec__29180,(1),null);
...
return cljs.core.get.call(null,arities,p1__29183_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.call(null,(2),p1__29184_SHARP_);
...
var args__4647__auto__ = [];
var len__4641__auto___29191 = arguments.length;
var i__4642__auto___29192 = (0);
while(true){
if((i__4642__auto___29192 < len__4641__auto___29191)){
args__4647__auto__.push((arguments[i__4642__auto___29192]));

var G__29193 = (i__4642__auto___29192 + (1));
i__4642__auto___29192 = G__29193;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__29187){
var vec__29188 = p__29187;
var humanize_QMARK_ = cljs.core.nth.call(null,vec__29188,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq29185){
var G__29186 = cljs.core.first.call(null,seq29185);
var seq29185__$1 = cljs.core.next.call(null,seq29185);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__29186,seq29185__$1);
});
...
var G__29194 = arg;
var G__29194__$1 = (((G__29194 instanceof cljs.core.Keyword))?G__29194.fqn:null);
switch (G__29194__$1) {
...
var include_ns_QMARK_ = cljs.core.get.call(null,map__29196__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.call(null,map__29196__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.call(null,map__29196__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.call(null,map__29196__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__29197 = devtools.munging.break_and_demunge_name.call(null,munged_name,ns_detector);
var fn_ns = cljs.core.nth.call(null,vec__29197,(0),null);
var fn_name = cljs.core.nth.call(null,vec__29197,(1),null);
var protocol_ns = cljs.core.nth.call(null,vec__29197,(2),null);
var protocol_name = cljs.core.nth.call(null,vec__29197,(3),null);
var protocol_method = cljs.core.nth.call(null,vec__29197,(4),null);
var arity = cljs.core.nth.call(null,vec__29197,(5),null);
...
var o__28775__auto__ = f;
return (o__28775__auto__["getBasis"]).call(o__28775__auto__);
});
/**
...
}catch (e29201){var _e__28782__auto__ = e29201;
...
var G__29202 = (obj[cljs.core.first.call(null,path)]);
var G__29203 = cljs.core.rest.call(null,path);
obj = G__29202;
path = G__29203;
continue;
} else {
...
return (function (accum,p__29204){
var vec__29205 = p__29204;
var bit = cljs.core.nth.call(null,vec__29205,(0),null);
var protocol = cljs.core.nth.call(null,vec__29205,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__29208){
var vec__29209 = p__29208;
var ns = cljs.core.nth.call(null,vec__29209,(0),null);
var name = cljs.core.nth.call(null,vec__29209,(1),null);
var selector = cljs.core.nth.call(null,vec__29209,(2),null);
...
var munged_name = cljs.core.nth.call(null,vec__29214,(0),null);
var matches__$1 = cljs.core.nth.call(null,vec__29214,(1),null);
...
var sorted_fns = cljs.core.map.call(null,((function (name,sorted_matches,vec__29214,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__29212_SHARP_){
return (obj[cljs.core.first.call(null,p1__29212_SHARP_)]);
});})(name,sorted_matches,vec__29214,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
...
//# sourceMappingURL=munging.js.map?rel=1545637584147
