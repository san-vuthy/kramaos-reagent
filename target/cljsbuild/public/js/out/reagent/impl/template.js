...
var G__33390 = o;
(G__33390[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
return (function() { 
var G__33391__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
var G__33391 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__33392__i = 0, G__33392__a = new Array(arguments.length -  0);
while (G__33392__i < G__33392__a.length) {G__33392__a[G__33392__i] = arguments[G__33392__i + 0]; ++G__33392__i;}
  args = new cljs.core.IndexedSeq(G__33392__a,0,null);
} 
return G__33391__delegate.call(this,args);};
...
return G__33391__delegate(args);
});
...
var G__33394 = o;
(G__33394[reagent.impl.template.cached_custom_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.ifn_QMARK_.call(null,x)){
return (function() { 
var G__33395__delegate = function (args){
return cljs.core.apply.call(null,x,args);
};
...
return G__33395__delegate.call(this,args);};
...
return G__33395__delegate(args);
});
...
var G__33399 = props;
var G__33399__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.call(null,G__33399,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__33399);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.call(null,G__33399__$1,new cljs.core.Keyword(null,"class","class",-2030961996),(function (){var old_class = new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props);
if((old_class == null)){
return class$;
} else {
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__33400){
...
var class$ = cljs.core.get.call(null,map__33401__$1,new cljs.core.Keyword(null,"class","class",-2030961996));
if(cljs.core.coll_QMARK_.call(null,class$)){
return cljs.core.assoc.call(null,props,new cljs.core.Keyword(null,"class","class",-2030961996),clojure.string.join.call(null," ",cljs.core.keep.call(null,((function (map__33401,map__33401__$1,props,class$){
return (function (c){
...
});})(map__33401,map__33401__$1,props,class$))
,class$)));
} else {
return props;
}
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__33403){
...
var on_write = cljs.core.get.call(null,map__33404__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return reagent.impl.batching.do_after_render.call(null,((function (node_value,map__33404,map__33404__$1,on_write){
return (function (){
return reagent.impl.template.input_component_set_value.call(null,component);
});})(node_value,map__33404,map__33404__$1,on_write))
);
} else {
...
var G__33407 = jsprops;
(G__33407["defaultValue"] = value);

(G__33407["onChange"] = ((function (G__33407,v,value,on_change){
return (function (p1__33406_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__33406_SHARP_);
});})(G__33407,v,value,on_change))
);
...
var vec__33410 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__33410,(0),null);
var id = cljs.core.nth.call(null,vec__33410,(1),null);
var class$ = cljs.core.nth.call(null,vec__33410,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___33414 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__5461__auto___33414 == null)){
} else {
var key_33415 = temp__5461__auto___33414;
(jsprops["key"] = key_33415);
}
...
var temp__5461__auto___33416 = reagent.impl.template.key_from_vec.call(null,argv);
if((temp__5461__auto___33416 == null)){
} else {
var key_33417 = temp__5461__auto___33416;
reagent.impl.template.oset.call(null,jsprops,"key",key_33417);
}
...
var G__33418 = reagent.impl.template.__GT_NativeWrapper.call(null);
(G__33418["name"] = c);
...
var len__4641__auto___33423 = arguments.length;
var i__4642__auto___33424 = (0);
while(true){
if((i__4642__auto___33424 < len__4641__auto___33423)){
args__4647__auto__.push((arguments[i__4642__auto___33424]));

var G__33425 = (i__4642__auto___33424 + (1));
i__4642__auto___33424 = G__33425;
continue;
} else {
}
break;
...
/** @this {Function} */
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq33421){
var G__33422 = cljs.core.first.call(null,seq33421);
var seq33421__$1 = cljs.core.next.call(null,seq33421);
var self__4628__auto__ = this;
return self__4628__auto__.cljs$core$IFn$_invoke$arity$variadic(G__33422,seq33421__$1);
});
...
break;
default:
var G__33428 = cljs.core.with_meta.call(null,new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,cljs.core.with_meta.call(null,v,null),(0),cljs.core.subs.call(null,n,(pos + (1))))], null),cljs.core.meta.call(null,v));
v = G__33428;
continue;
...
var n__4518__auto___33430 = a.length;
var i_33431 = (0);
while(true){
if((i_33431 < n__4518__auto___33430)){
(a[i_33431] = reagent.impl.template.as_element.call(null,(a[i_33431])));

var G__33432 = (i_33431 + (1));
i_33431 = G__33432;
continue;
} else {
}
...
var a = cljs.core.into_array.call(null,s);
var n__4518__auto___33433 = a.length;
var i_33434 = (0);
while(true){
if((i_33434 < n__4518__auto___33433)){
var val_33435 = (a[i_33434]);
if(((cljs.core.vector_QMARK_.call(null,val_33435)) && ((reagent.impl.template.key_from_vec.call(null,val_33435) == null)))){
(o["no-key"] = true);
} else {
}

(a[i_33434] = reagent.impl.template.as_element.call(null,val_33435));
...
var ctx = ({});
var vec__33437 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__33437,(0),null);
var derefed = cljs.core.nth.call(null,vec__33437,(1),null);
...
var G__33440 = (cljs.core.count.call(null,argv) - first_child);
switch (G__33440) {
case (0):
...
break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv.call(null,((function (G__33440){
...
//# sourceMappingURL=template.js.map?rel=1545662209015
