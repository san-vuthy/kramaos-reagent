...
return (new CustomEvent(event_name,(function (){var obj34728 = {"detail":data};
return obj34728;
})()));
} else {
...
var f = (function (){var pred__34735 = cljs.core._EQ_;
var expr__34736 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__34735.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__34736))){
return ((function (pred__34735,expr__34736){
return (function (p1__34729_SHARP_){
return console.warn(p1__34729_SHARP_);
});
;})(pred__34735,expr__34736))
} else {
if(cljs.core.truth_(pred__34735.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__34736))){
return ((function (pred__34735,expr__34736){
return (function (p1__34730_SHARP_){
return console.debug(p1__34730_SHARP_);
});
;})(pred__34735,expr__34736))
} else {
if(cljs.core.truth_(pred__34735.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__34736))){
return ((function (pred__34735,expr__34736){
return (function (p1__34731_SHARP_){
return console.error(p1__34731_SHARP_);
});
;})(pred__34735,expr__34736))
} else {
return ((function (pred__34735,expr__34736){
return (function (p1__34732_SHARP_){
return console.log(p1__34732_SHARP_);
});
;})(pred__34735,expr__34736))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__34739){
...
var opts = map__34740__$1;
var eval_fn = cljs.core.get.call(null,map__34740__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__34742_SHARP_);
});})(new_def))
);
...
return (function (p__34743){
var vec__34744 = p__34743;
var ky = cljs.core.nth.call(null,vec__34744,(0),null);
var v = cljs.core.nth.call(null,vec__34744,(1),null);
...
//# sourceMappingURL=utils.js.map?rel=1545637593911
